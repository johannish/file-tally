...
::repo::insert uploads {name "Tcl File" description "This is a file" type "config file" uploader "jordanMiller" blob "001010111010101010" tags "configs, other tags, etc." votes "1" programs_id "1"}
::repo::insert uploads {name "TK File" description "This is a file" type "config file" uploader "jordanMiller" blob "001010111010101011" tags "configs, other tags, etc." votes "1" programs_id "1"}
